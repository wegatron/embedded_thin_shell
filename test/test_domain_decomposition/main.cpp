...
int main(int argc, char *argv[])
{
    ...
    jtf::mesh::tet_mesh_read_from_zjumat("/home/wegatron/workspace/embedded_thin_shell/branches/chenjiong/dat/sphere/orig.tet",
                                         &tet_nodes, &tet_mesh);
    ...
    {
        char *out = "/home/wegatron/workspace/embedded_thin_shell/branches/chenjiong/result_1/tri_surface.vtk";
        std::ofstream os(out);
    ...
    for (size_t i = 0; i < patches.size(); ++i) {
         ostringstream oss;
         oss << "/home/wegatron/workspace/embedded_thin_shell/branches/chenjiong/result_1/patches_" << i << ".vtk";
